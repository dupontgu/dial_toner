from config import Config, INPUT_VALS, BRIGHTNESS_VALS, OUTPUT_VALS, KEYBOARD_VALS, APPEND_VALS
...
all_params = [
    ...
    ConfigParam("APPEND", Config.set_append_key, lambda p: p.append_key,  APPEND_VALS)
]